...
const MovieCard = ({movie}) => {
  ...
  return (
    <div className='bg-gray-800 w-66 rounded-2xl px-4 py-2 m-3'>
        <img onClick={()=>{navigate(`/moviedetails/${movie._id}`); scroll(0,0);}} src={movie.backdrop_path} alt="" className='rounded-lg h-65  w-full object-cover cursor-pointer mt-2 shadow-[0_0_10px_rgba(0,0,0,0.6)]' />
