...
import { CameraIcon, TrashIcon, ArrowLeftIcon } from 'lucide-react'
...
const AddCast = () => {
  ...
  const { movie, handleGetMovieById } = useMovie()
  ...
  return (
    <div className='relative overflow-x-hidden'>
      ...
      {movie && (
        <div className='flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8'>
          <img
            ...
            alt={movie.title}
            className='w-14 h-20 sm:w-16 sm:h-24 rounded-md object-cover border border-primary/20'
          />
          <div>
            <p className='text-xs sm:text-sm text-gray-400'>Adding cast for</p>
      ...
      {/* Existing cast list */}
      <p className='text-sm sm:text-base md:text-lg font-medium mt-8 sm:mt-10 mb-3 sm:mb-4'>
        Cast ({casts.length})
      </p>
