...
const TOTAL_SEATS = 90 // matches the show schema's default `ticket` value
  ...
  return (
    <div className='relative overflow-x-hidden'>
      ...
      {loading && shows.length === 0 ? (
        ...
        <p className='text-sm text-gray-400 mt-4 sm:mt-6 h-screen'>No shows added yet.</p>
      ) : (
              ...
              {shows.map((show) => {
                ...
                return (
                  <tr key={show._id} className='border-t border-primary/10'>
                    ...
                    <td className='px-3 sm:px-4 md:px-5 py-2.5 sm:py-3'>{totalBooking}</td>
